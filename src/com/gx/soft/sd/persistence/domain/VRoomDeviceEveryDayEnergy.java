...
@Entity
@Table(name = "v_room_device_every_day_energy", schema = "jbxqycy", catalog = "")
public class VRoomDeviceEveryDayEnergy {
    private String vKey;
    ...
    public boolean equals(Object o) {
        ...
        VRoomDeviceEveryDayEnergy that = (VRoomDeviceEveryDayEnergy) o;
