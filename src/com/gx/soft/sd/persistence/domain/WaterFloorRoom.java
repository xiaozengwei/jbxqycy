...
@Entity
@Table(name = "water_floor_room", schema = "jbxqycy", catalog = "")
public class WaterFloorRoom {
    ...
    public boolean equals(Object o) {
        ...
        WaterFloorRoom room = (WaterFloorRoom) o;

        if (rowId != null ? !rowId.equals(room.rowId) : room.rowId != null) return false;
        if (rowName != null ? !rowName.equals(room.rowName) : room.rowName != null) return false;
        if (pFloorId != null ? !pFloorId.equals(room.pFloorId) : room.pFloorId != null) return false;
        if (pFloorName != null ? !pFloorName.equals(room.pFloorName) : room.pFloorName != null) return false;
        if (floorType != null ? !floorType.equals(room.floorType) : room.floorType != null) return false;
