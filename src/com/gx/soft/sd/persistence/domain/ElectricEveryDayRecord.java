...
@Entity
@Table(name = "electric_every_day_record", schema = "jbxqycy", catalog = "")
public class ElectricEveryDayRecord {
    ...
    public boolean equals(Object o) {
        ...
        ElectricEveryDayRecord that = (ElectricEveryDayRecord) o;
