...
/**
 * SdRechargeFailRecord entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "sd_recharge_fail_record", catalog = "jbxqycy")
public class SdRechargeFailRecord implements java.io.Serializable {
	...
	/** default constructor */
	public SdRechargeFailRecord() {
	}

	/** full constructor */
	public SdRechargeFailRecord(String outTradeNo, String roomId,
			String deviceId, String userName, String openId, String userIdCard,
