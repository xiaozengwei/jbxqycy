...
/**
 * WxAttachment entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "wx_attachment", catalog = "jbxqycy")
public class WxAttachment implements java.io.Serializable {
	...
	/** full constructor */
	public WxAttachment(String relationId, String attachName,
			String attachType, String attachFileIdentifyName,
