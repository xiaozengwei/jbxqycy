 ...
 */
@Entity
@Table(name = "v_ykt_inst_act", catalog = "jbxqycy")
public class VYktInstAct implements java.io.Serializable {
	...
	/** full constructor */
	public VYktInstAct(String rowId, String actId, String actName, String handleUser, String handleUser1, String actBack,
					   ...
					   String applicantPhone, String applicantIdCard, String companyName, Integer cardNumber,
