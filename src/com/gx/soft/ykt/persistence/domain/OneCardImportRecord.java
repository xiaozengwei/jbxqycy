...
/**
 * OneCardImportRecord entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "one_card_import_record", catalog = "jbxqycy")
public class OneCardImportRecord implements java.io.Serializable {
	...
	/** default constructor */
	public OneCardImportRecord() {
	}

	/** full constructor */
	public OneCardImportRecord(String fileName, String fileType,
