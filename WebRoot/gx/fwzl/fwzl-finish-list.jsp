...
<form id="pagerForm" data-toggle="ajaxsearch" action="<%=basePath %>fwzl/fwzl-progress-list.do" method="post">
	        ...
	        <div class="bjui-searchBar" style="line-height:60px">
				...
				&nbsp;
				<a type="button" id="exportBtn" class="btn btn-green" data-icon="sign-out" href="<%=basePath %>fwzl/export-excel.do" data-toggle="doexport" data-confirm-msg="确定要导出吗？">导出数据</a>
	        </div>
</form>
</div>
