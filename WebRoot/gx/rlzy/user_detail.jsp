...
<script type="text/javascript">
	$(function() {
		...
		//$("#j_custom_sale3").val('${user.identityAttribute}');
...
<div class="bjui-pageContent">
	<table style="width: 70%;margin: auto auto">
		<tr>
				...
				<table width="90%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						...
						<td rowspan="6" align="center" valign="middle">
							<span class="pic-box"><img id="getPath"
					...
					<tr>
						...
						<td colspan="2">
							<!-- <select name="userSex" id="j_custom_sale" data-toggle="selectpicker" data-rule="required">
      ...
      <option value="女">女</option>
					...
					<tr>
						...
						<td align="left"><select name="identityAttribute"
							id="j_custom_sale3" data-toggle="selectpicker"
							data-rule="required">
								<option value="无">无</option>
					...
					<tr>
						...
						<td colspan="3" align="left"><textarea name="remark"
								id="j_custom_note" data-toggle="autoheight" cols="50" rows="3"
