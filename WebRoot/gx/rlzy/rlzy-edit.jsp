...
<script type="text/javascript">
	...
	$(function() {
		$("#j_custom_sale").val('${user.userSex}');
		$("#j_custom_sale1").val('${user.userLevel}');
		$("#j_custom_sale2").val('${user.userDegree}');
		$("#j_custom_sale3").val('${user.userLevel2}');
		$("#j_custom_sale4").val('${user.userDegree2}');
		//$("#j_custom_sale6").val('${user.identityAttribute}');
		$("#j_custom_sale7").val('${user.political}');
		
		var a = $("#text1").val();
		if (a.indexOf(",") != -1) {
			var n = a.split(",");
			for ( var i = 0; i < n.length; i++) {
				$("#j_custom_sale5 option").each(function(){
					var s=$(this).val();
					 if(s==n[i]){
			...
			$("#j_custom_sale5").val('${user.userTitle}');
		}
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			...
			<form method="post" action="<%=basePath %>hr/saveOrUpdate.do"
					data-toggle="validate" id="noticeContentForm" data-reloadNavtab="false">
					<input name="rowId"
						value="${user.rowId }" type="hidden"><input name="userId"
						value="${user.userId }" type="hidden"> <input name="betweenId"
						value="${betweenId }" type="hidden"><input name="sysUserId"
						value="${sysUserId }" type="hidden">
				<table width="90%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						...
						<td rowspan="7" align="center" valign="middle"><span class="pic-box"><img id="getPath"
							src="<%=basePath %>readImage.do?filePath=${user.userPhoto}" width="100%" height="211" /></span>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="2" align="left"><input type="text"
							...
							value="${fn:substring(user.userBirthday, 0, 10) }" data-toggle="datepicker"
					...
					<tr>
						...
						<td colspan="2" align="left"><input type="text"
							name="userTeam" id="j_custom_passportno7"
							value="${user.userTeam }" data-rule="required"  data-target="#j_custom_passportno7"
							style="font-size:12px" class="bdform-control">
						</td>
					</tr>
					<tr>
						...
						<td colspan="2" align="left"><input type="text"
							name="userCardId" id="j_custom_passportno6"  data-target="#j_custom_passportno6"
							value="${user.userCardId }" data-rule="required;ID_card"
							style="font-size:12px" class="bdform-control" onblur="check1(this)"><span id="card1" style="color: red"></span>
							<input type="hidden" value="${user.userCardId }" id="value1">
						</td>
					</tr>
					...
					<tr>
						...
						<td colspan="2">
							<input id="upload-file-list_<%=random %>" size="15" readonly="readonly" name="userPhoto" value="${user.userPhoto }"/> 
					...
					<tr>
						...
						<td width="25%" align="left"><input type="text"
							...
							value="${user.userOrigin}" data-rule="required"
							style="font-size:12px" class="bdform-control">
						</td>
						<td width="25%" class="control-label x100">出生地：</td>
						<td width="25%" align="left"><input type="text"
							name="userBirthPlace" id="j_custom_passportno"
							value="${user.userBirthPlace }" 
							style="font-size:12px" class="bdform-control">
						</td>
					</tr>
					<tr>
						<td class="control-label x100">学历（第一学历）：</td>
						<td><select name="userLevel" id="j_custom_sale1"  data-target="#j_custom_sale1"
							data-toggle="selectpicker" data-rule="required">
						...
						<td><select name="userDegree" id="j_custom_sale2"  data-target="#j_custom_sale2"
					...
					<tr>
						...
						<td align="left"><input type="text" name="userSchool"  data-target="#j_custom_passportno4"
						...
						<td align="left"><input type="text" name="userMajor"   data-target="#j_custom_passportno3"
					...
					<tr>
						...
						<td align="left"><input type="text"
							name="userJob" id="j_custom_passportno2" value="${user.userJob }"
					...
					<tr>
						...
						<td align="left"><input type="text"
							name="jobTime" id="j_custom_issuedate" value="${fn:substring(user.jobTime,0,10) }"
					...
					<tr>
						...
						<td align="left"><input type="text"
							name="incumbentTime" id="j_custom_issuedate"
					...
					<tr>
						...
						<%-- <td width="25%" class="control-label x100">OA帐号：</td>
						<td align="left"><input type="text" name="oaId"
							id="j_custom_passportno0" value="${user.oaId }"
							 style="font-size:12px"  data-rule="required"  data-target="#j_custom_passportno0"
							class="bdform-control"  onblur="check1(this)"><span id="card2" style="color: red"></span>
							<input type="hidden" value="${user.oaId }" id="value2">
							</td> --%>
