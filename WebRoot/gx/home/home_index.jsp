...
<!-- 百度地图 -->
<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=54OGN6tEjulb4PohvRkojka07FuSWbl9"></script>
<!-- ECharts -->
<script src="<%=request.getContextPath()%>/gx/BJUI/plugins/echarts/echarts.js"></script>
<!-- 打印 -->
<script src="<%=request.getContextPath()%>/gx/js/jquery.printarea.js"></script>
<!-- init -->
...
<body><input id="isOpenDefaultPage" type="hidden" value="0"/>
    ...
    <header id="bjui-header">
        ...
        <nav id="bjui-navbar-collapse">
            <ul class="bjui-navbar-right">
                ...
                <li ></li>
                <li class="dropdown"><a href="#" style="font-size: 12px;" class="dropdown-toggle" data-toggle="dropdown">您好!${userName}<span class="caret"></span></a>
        ...
        <div id="bjui-hnav" >
            ...
            <div id="bjui-hnav-navbar-box" >
                ...
                <%
					...
					%>          
            <li id="I<%=functionLvevl1.get(i).getRowId()%>" data-id="I<%=functionLvevl1.get(i).getRowId()%>" ><a href="javascript:;" data-toggle="slidebar"  ><i class="fa fa-check-square-o"></i><%=functionLvevl1.get(i).getFunctionName()%></a>
               <div class="items hide" data-noinit="true">
                            <ul id="I<%=functionLvevl1.get(i).getRowId()%>" class="ztree ztree_main" data-toggle="ztree" data-on-click="MainMenuClick"  data-faicon="check-square-o" data-options="{expandAll:true}">
						<%
			...
			<%}}//一级循环结束%>
              ...
              <input type="hidden" id="dbtest" name="dbt"/>
            </div>
    ...
    <div id="bjui-container">
        ...
        <div id="bjui-navtab" class="tabsPage" data-onload="load()">
            <div class="tabsPageHeader">
                <div class="tabsPageHeaderContent">
                    <ul class="navtab-tab nav nav-tabs">
                        <li data-url="<%=basePath %>home/to-index-layout.do" data-autorefresh=200 ><a href="javascript:;"><span><i class="fa fa-home"></i> #maintab#</span></a></li>
                    </ul>
                </div>
    ...
    <footer id="bjui-footer">Copyright &copy; 2018　<a href="" target="_blank">南京江北新区产业技术研创园</a></footer>
    </div>
</body>
</html>