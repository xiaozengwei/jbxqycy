...
<div class="bjui-pageContent">
    <form action="<%=basePath%>sysuser/user-save.do?orgId=${orgId}" method="post" data-toggle="validate" data-reloadNavtab="false">
            ...
            <tbody>
                ...
                <tr>
                	<td>
                        ...
                        <input type="text" name="userId"  value="${model.userId}" data-rule="required" size="20">
                    </td>
                </tr>
                <tr>
                	<td>
