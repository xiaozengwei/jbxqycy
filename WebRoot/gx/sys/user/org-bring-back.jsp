...
<script type="text/javascript">
	function do_open_layout(event, treeId, treeNode) {
		...
		var org_selected_layout = $.CurrentDialog.find("#layout-org-selected");
		var layout_orgs = $.CurrentDialog.find("#layout-tree-org");
...
<div class="bjui-pageContent" style="" id="user-select-page">
	<form action="<%=basePath%>sysuser/user-org-update.do?userId=${userId}"
		method="post" data-toggle="validate" data-reloadNavtab="false"
		id="user-change-org-form">
		<input type="hidden" name="orgId" value="" id="orgId" />
		<div style="width:99%;height: 99%;">
			<div style=" float:left;width:290px;height:90%;">
				<fieldset style="height:100%;">
					<legend>组织机构</legend>
					<div id="orgtree" style="height:94%;overflow: auto; ">
						<ul id="layout-tree-org" class="ztree" data-toggle="ztree"
			...
			<div style="float:left;margin-left:10px; height:90%; width:290px;">
				<div style="height:100%;">
					<fieldset style="height:100%;">
						<legend>已选单位</legend>
						<div id="layout-org-selected" style="height:94%; overflow: auto;">
...
<script>
	$(function() {
		...
		$("#btn-org-select", $.CurrentDialog).on("click", function() {
			...
			$.CurrentDialog.find("#user-change-org-form").submit();
