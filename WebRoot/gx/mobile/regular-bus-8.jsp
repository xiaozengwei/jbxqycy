...
<header>
    <div class="div-title">
        ...
        <span class="span-title">Y8</span>
    </div>
</header>
<div style="height: 30px;">
    <span style="line-height: 30px;font-size: 13px;font-weight: bold;">膜园-耀华-光电科技园-行知路·雨合路-雨山路地铁站</span>
</div>
<div class="weui-grids">
    ...
    <a class="weui-grid js_grid" style="padding:2px 2px;width: 20%;">
        <p class="weui-grid__label" style="font-size: 12px;">
            <span style="color: #a4a1a1;">18:08</span>
        </p>
    </a>
    <a class="weui-grid js_grid" style="padding:2px 2px;width: 20%;">
        <p class="weui-grid__label" style="font-size: 12px;">
    ...
    <a class="weui-grid js_grid" style="padding:2px 2px;width: 20%;">
        <p class="weui-grid__label" style="font-size: 12px;">
            <span style="color: #a4a1a1;">21:02</span>
        </p>
    </a>
    ...
    <a class="weui-grid js_grid" style="padding:2px 2px;width: 20%;">
        <p class="weui-grid__label" style="font-size: 12px;">
            <span style="color: #a4a1a1;">21:10</span>
        </p>
    </a>
