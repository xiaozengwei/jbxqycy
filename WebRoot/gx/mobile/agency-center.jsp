...
<header>
    <div class="div-title">
        ...
        <span class="span-title">代办中心</span>
    </div>
    <div>
        <img src="<%=basePath %>gx/mobile/images/agency-center.jpg" width="100%" alt="">
    </div>
</header>
<div style="height: 30px;">
    <span style="line-height: 30px;font-size: 13px;font-weight: bold;"><span style="border-left:3px #5b93ee solid;line-height:18px;display: inline-block;width: 5px;margin-left: 5px;">&nbsp;</span>代办服务中心</span>
</div>
<div class="weui-grids">
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 100%;">
        <p style="text-align: left;font-size: 12px;color: #a4a1a1;padding: 5px; text-indent: 24px;">
            代办服务中心作为统一面向研创园本部片区、五桥片区及隧道片区企业办理行政审批和服务事项的中心，目前共有设10个窗口。各窗口实行一窗受理、一窗办结、全程代办的工作机制，可为企业提供工商企业登记注册及变更、规费收取、规划建设工程申报、市政工程项目规划申报、临时建筑项目规划申报、银行开户、社保办理、税务登记、综合代办窗口、综合窗口咨询等一系列服务。
        </p>
    </a>
</div>
<style>
