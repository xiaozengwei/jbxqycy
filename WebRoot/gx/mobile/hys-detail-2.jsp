...
<body ontouchstart>
<header>
    <img src="<%=basePath %>gx/mobile/hys-img/xjt-1.jpg" width="100%" alt="">
</header>
...
<div class="weui-grids">
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 55%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;">
            <img src="<%=basePath %>gx/mobile/images/img_jzmj.png" width="20px" alt="" align="absmiddle" style="margin-right: 5px;">建筑面积：<span style="color: #a4a1a1;">274m²</span>
        </p>
    </a>
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 45%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;">
            <img src="<%=basePath %>gx/mobile/images/img_cc.png" width="20px" alt="" align="absmiddle" style="margin-right: 5px;">长度*宽度：<span style="color: #a4a1a1;">9m*30.4m</span>
        </p>
    </a>
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 55%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;">
            <img src="<%=basePath %>gx/mobile/images/img_pm.png" width="20px" alt="" align="absmiddle" style="margin-right: 5px;">屏幕尺寸：<span style="color: #a4a1a1;">6000mm*1600mm</span>
        </p>
    </a>
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 45%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;">
            <img src="<%=basePath %>gx/mobile/images/img_fbl.png" width="20px" alt="" align="absmiddle" style="margin-right: 5px;">分辨率：<span style="color: #a4a1a1;">1920*1080</span>
        </p>
    </a>
    ...
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 100%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;">
            <img src="<%=basePath %>gx/mobile/images/img_rnrs.png" width="20px" alt="" align="absmiddle" style="margin-right: 5px;">容纳人数&nbsp; &nbsp;课桌式：<span style="color: #a4a1a1;">60-110人</span>&nbsp; &nbsp;剧院式：<span style="color: #a4a1a1;">120-150人</span>&nbsp; &nbsp;U型：<span style="color: #a4a1a1;">26-30人</span>
        </p>
    </a>
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 100%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;">
            <img src="<%=basePath %>gx/mobile/images/img_wz.png" width="20px" alt="" align="absmiddle" style="margin-right: 5px;">位置：<span style="color: #a4a1a1;">江北新区团结路99号研创园孵鹰大厦C座204会议室</span>
        </p>
    </a>
</div>
<div style="height: 30px;">
