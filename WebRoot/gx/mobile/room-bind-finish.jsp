...
<div class="weui-msg">
    ...
    <div class="weui-msg__text-area">
        <h2 class="weui-msg__title">您已经绑定过房间号：${roomId}</h2>
    </div>
    <div class="weui-msg__opr-area">
        <div class="weui-btn-area">
            <a href="<%=basePath %>mobile/unbind-room.do" class="weui-btn weui-btn_primary" style="background-color: #387ef8;">解除绑定</a>
