...
<body ontouchstart>
<header>
    <img src="<%=basePath %>gx/mobile/hys-img/hys3-1.jpg" width="100%" alt="">
</header>
...
<div class="weui-grids">
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 50%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;">
            <img src="<%=basePath %>gx/mobile/images/img_jzmj.png" width="20px" alt="" align="absmiddle" style="margin-right: 5px;">建筑面积：<span style="color: #a4a1a1;">36㎡</span>
        </p>
    </a>
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 50%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;">
            <img src="<%=basePath %>gx/mobile/images/img_cc.png" width="20px" alt="" align="absmiddle" style="margin-right: 5px;">长度*宽度：<span style="color: #a4a1a1;">8.5m*4.2m</span>
        </p>
    </a>
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 50%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;">
            <img src="<%=basePath %>gx/mobile/images/img_pm.png" width="20px" alt="" align="absmiddle" style="margin-right: 5px;">屏幕尺寸：<span style="color: #a4a1a1;">无投影设备</span>
        </p>
    </a>
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 50%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;">
            <img src="<%=basePath %>gx/mobile/images/img_fbl.png" width="20px" alt="" align="absmiddle" style="margin-right: 5px;">分辨率：<span style="color: #a4a1a1;">无投影设备</span>
        </p>
    </a>
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 100%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;">
            <img src="<%=basePath %>gx/mobile/images/img_cdf.png" width="20px" alt="" align="absmiddle" style="margin-right: 5px;">场地费&nbsp;&nbsp;全天：<span style="color: #a4a1a1;">1200元</span>&nbsp;&nbsp;半天：<span style="color: #a4a1a1;">700元</span>
        </p>
    </a>
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 100%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;">
            <img src="<%=basePath %>gx/mobile/images/img_zk.png" width="20px" alt="" align="absmiddle" style="margin-right: 5px;">园区六折：&nbsp;&nbsp;全天：<span style="color: #a4a1a1;">700元</span>&nbsp;&nbsp;半天：<span style="color: #a4a1a1;">500元</span>
        </p>
    </a>
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 100%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;">
            <img src="<%=basePath %>gx/mobile/images/img_rnrs.png" width="20px" alt="" align="absmiddle" style="margin-right: 5px;">容纳人数&nbsp; &nbsp;课桌式：<span style="color: #a4a1a1;">/</span>&nbsp; &nbsp;剧院式：<span style="color: #a4a1a1;">/</span>&nbsp; &nbsp;U型：<span style="color: #a4a1a1;">16人</span>
        </p>
    </a>
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 100%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;">
            <img src="<%=basePath %>gx/mobile/images/img_wz.png" width="20px" alt="" align="absmiddle" style="margin-right: 5px;">位置：<span style="color: #a4a1a1;">华创路与江淼路交叉口西南100米腾飞大厦4楼403-1</span>
        </p>
    </a>
</div>
<div style="height: 30px;">
