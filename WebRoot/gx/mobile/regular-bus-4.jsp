...
<header>
    <div class="div-title">
        ...
        <span class="span-title">Y4</span>
    </div>
</header>
<div style="height: 30px;">
    <span style="line-height: 30px;font-size: 13px;font-weight: bold;">临江地铁站→云驰街站→光电科技园→耀华→膜园</span>
</div>
...
<div class="weui-grids">
    ...
    <a class="weui-grid js_grid" style="padding:2px 2px;width: 100%;">
        <p class="weui-grid__label" style="font-size: 12px;">
            <span style="color: #a4a1a1;">19:00至21:00每1小时发车一趟</span>
        </p>
    </a>
</div>
