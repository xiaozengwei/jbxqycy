...
<body ontouchstart>
<header>
    <img src="<%=basePath %>gx/mobile/hys-img/hys2-1.jpg" width="100%" alt="">
</header>
...
<div class="weui-grids">
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 55%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;">
            <img src="<%=basePath %>gx/mobile/images/img_jzmj.png" width="20px" alt="" align="absmiddle" style="margin-right: 5px;">建筑面积：<span style="color: #a4a1a1;">120㎡</span>
        </p>
    </a>
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 45%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;">
            <img src="<%=basePath %>gx/mobile/images/img_cc.png" width="20px" alt="" align="absmiddle" style="margin-right: 5px;">长度*宽度：<span style="color: #a4a1a1;">9.2m*13m</span>
        </p>
    </a>
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 55%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;">
    ...
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 100%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;">
            <img src="<%=basePath %>gx/mobile/images/img_cdf.png" width="20px" alt="" align="absmiddle" style="margin-right: 5px;">场地费&nbsp;&nbsp;全天：<span style="color: #a4a1a1;">2000元</span>&nbsp;&nbsp;半天：<span style="color: #a4a1a1;">1200元</span>
        </p>
    </a>
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 100%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;">
            <img src="<%=basePath %>gx/mobile/images/img_zk.png" width="20px" alt="" align="absmiddle" style="margin-right: 5px;">园区六折：&nbsp;&nbsp;全天：<span style="color: #a4a1a1;">1200元</span>&nbsp;&nbsp;半天：<span style="color: #a4a1a1;">900元</span>
        </p>
    </a>
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 100%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;">
            <img src="<%=basePath %>gx/mobile/images/img_rnrs.png" width="20px" alt="" align="absmiddle" style="margin-right: 5px;">容纳人数&nbsp; &nbsp;课桌式：<span style="color: #a4a1a1;">/</span>&nbsp; &nbsp;剧院式：<span style="color: #a4a1a1;">/</span>&nbsp; &nbsp;U型：<span style="color: #a4a1a1;">30人</span>
        </p>
    </a>
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 100%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;">
            <img src="<%=basePath %>gx/mobile/images/img_wz.png" width="20px" alt="" align="absmiddle" style="margin-right: 5px;">位置：<span style="color: #a4a1a1;">华创路与江淼路交叉口西南100米腾飞大厦4楼402</span>
        </p>
    </a>
</div>
<div style="height: 30px;">
