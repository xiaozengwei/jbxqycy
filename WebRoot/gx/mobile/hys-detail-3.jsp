...
<header>
    <figure id="full_feature" class="swipslider">
        <ul class="sw-slides">
            <li class="sw-slide">
                <img src="<%=basePath %>gx/mobile/hys-img/dbgt-1.jpg" width="100%" alt="">
            </li>
            <li class="sw-slide">
                <img src="<%=basePath %>gx/mobile/hys-img/dbgt-2.jpg" width="100%" alt="">
            </li>
            <li class="sw-slide">
                <img src="<%=basePath %>gx/mobile/hys-img/dbgt-3.jpg" width="100%" alt="">
            </li>
        </ul>
    </figure>
</header>
...
<div class="weui-grids">
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 55%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;">
            <img src="<%=basePath %>gx/mobile/images/img_jzmj.png" width="20px" alt="" align="absmiddle" style="margin-right: 5px;">建筑面积：<span style="color: #a4a1a1;">473m²</span>
        </p>
    </a>
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 45%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;">
            <img src="<%=basePath %>gx/mobile/images/img_cc.png" width="20px" alt="" align="absmiddle" style="margin-right: 5px;">长度*宽度：<span style="color: #a4a1a1;">21.5m*22m</span>
        </p>
    </a>
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 55%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;">
            <img src="<%=basePath %>gx/mobile/images/img_pm.png" width="20px" alt="" align="absmiddle" style="margin-right: 5px;">屏幕尺寸：<span style="color: #a4a1a1;">10660mm*2980mm</span>
        </p>
    </a>
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 45%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;">
            <img src="<%=basePath %>gx/mobile/images/img_fbl.png" width="20px" alt="" align="absmiddle" style="margin-right: 5px;">分辨率：<span style="color: #a4a1a1;">5760*1620</span>
        </p>
    </a>
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 100%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;">
            <img src="<%=basePath %>gx/mobile/images/img_cdf.png" width="20px" alt="" align="absmiddle" style="margin-right: 5px;">场地费&nbsp;&nbsp;全天：<span style="color: #a4a1a1;">5000元</span>&nbsp;&nbsp;半天：<span style="color: #a4a1a1;">3000元</span>
        </p>
    </a>
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 100%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;">
            <img src="<%=basePath %>gx/mobile/images/img_zk.png" width="20px" alt="" align="absmiddle" style="margin-right: 5px;">园区六折：&nbsp;&nbsp;全天：<span style="color: #a4a1a1;">3000元</span>&nbsp;&nbsp;半天：<span style="color: #a4a1a1;">1800元</span>
        </p>
    </a>
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 100%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;">
            <img src="<%=basePath %>gx/mobile/images/img_rnrs.png" width="20px" alt="" align="absmiddle" style="margin-right: 5px;">容纳人数&nbsp; &nbsp;课桌式：<span style="color: #a4a1a1;">150-180人</span>&nbsp; &nbsp;剧院式：<span style="color: #a4a1a1;">260-300人</span>&nbsp; &nbsp;U型：<span style="color: #a4a1a1;">28-36人</span>
        </p>
    </a>
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 100%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;">
            <img src="<%=basePath %>gx/mobile/images/img_wz.png" width="20px" alt="" align="absmiddle" style="margin-right: 5px;">位置：<span style="color: #a4a1a1;">江北新区江淼路88号研创园腾飞大厦D座4楼大报告厅</span>
        </p>
    </a>
</div>
<div style="height: 30px;">
