...
<header>
    <div class="div-title">
        ...
        <span class="span-title">水电充值</span>
    </div>
</header>
<div class="weui-grids" style="background-color: white;">
    <a href="<%=basePath %>mobile/to-sd-recharge.do?rechargeType=1" class="weui-grid js_grid" style="padding:10px 10px;width: 50%;">
    ...
    <a href="<%=basePath %>mobile/to-sd-recharge.do?rechargeType=2" class="weui-grid js_grid" style="padding:10px 10px;width: 50%;">
        <div class="weui-grid__icon">
