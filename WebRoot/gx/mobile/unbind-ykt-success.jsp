...
<div class="weui-msg">
    ...
    <div class="weui-msg__text-area">
        <h2 class="weui-msg__title">一卡通解除绑定成功！</h2>
    </div>
    <div class="weui-msg__opr-area">
        <div class="weui-btn-area">
            <a href="<%=basePath %>mobile/to-ykt-bind.do" class="weui-btn weui-btn_primary" style="background-color: #387ef8;">一卡通绑定</a>
            <a href="<%=basePath %>mobile/index.do" class="weui-btn weui-btn_primary">返回</a>
        </div>
    </div>
