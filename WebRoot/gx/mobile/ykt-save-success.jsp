...
<div class="weui-msg">
    ...
    <div class="weui-msg__text-area">
        <h2 class="weui-msg__title">保存成功，请支付一卡通费用</h2>
    </div>
    <div class="weui-msg__opr-area">
        <p class="weui-btn-area">
            <a href="<%=basePath %>mobile/to-ykt-pay.do?rowId=${rowId}" class="weui-btn weui-btn_primary" style="background-color: #387ef8;width: 80%;">立即支付</a>
        </p>
    </div>
