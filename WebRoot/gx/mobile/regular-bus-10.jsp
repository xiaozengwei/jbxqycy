...
<header>
    <div class="div-title">
        ...
        <span class="span-title">Y10</span>
    </div>
</header>
<div style="height: 30px;">
    <span style="line-height: 30px;font-size: 13px;font-weight: bold;">兰花塘地铁站—光电科技园</span>
</div>
<div class="weui-grids">
    <a class="weui-grid js_grid" style="padding:2px 2px;width: 50%;">
        <p class="weui-grid__label" style="font-size: 12px;">
            <span style="font-weight:bold;">兰花塘地铁站—光电科技园</span>
        </p>
    </a>
    <a class="weui-grid js_grid" style="padding:2px 2px;width: 50%;">
        <p class="weui-grid__label" style="font-size: 12px;">
            <span style="font-weight:bold;">发车时间（8:50）</span>
        </p>
    </a>

    <a class="weui-grid js_grid" style="padding:2px 2px;width: 50%;">
        <p class="weui-grid__label" style="font-size: 12px;">
            <span style="color: #a4a1a1;">兰花塘地铁站</span>
        </p>
    </a>
    <a class="weui-grid js_grid" style="padding:2px 2px;width: 50%;">
        <p class="weui-grid__label" style="font-size: 12px;">
...
<div style="height: 30px;">
    <span style="line-height: 30px;font-size: 13px;font-weight: bold;">光电科技园-兰花塘地铁站</span>
</div>
<div class="weui-grids">
    <a class="weui-grid js_grid" style="padding:2px 2px;width: 50%;">
        <p class="weui-grid__label" style="font-size: 12px;">
            <span style="font-weight:bold;">光电科技园-兰花塘地铁站</span>
        </p>
    </a>
    <a class="weui-grid js_grid" style="padding:2px 2px;width: 50%;">
        <p class="weui-grid__label" style="font-size: 12px;">
            <span style="font-weight:bold;">发车时间（17:00）</span>
        </p>
    </a>
