...
<header>
    <div class="div-title">
        ...
        <span class="span-title">机场大巴</span>
    </div>
    <div>
        <img src="<%=basePath %>gx/mobile/images/shuttle-bus.jpg" width="100%" alt="">
    </div>
</header>
<div style="height: 30px;">
    <span style="line-height: 30px;font-size: 13px;font-weight: bold;"><span style="border-left:3px #5b93ee solid;line-height:18px;display: inline-block;width: 5px;margin-left: 5px;">&nbsp;</span>候机楼班车</span>
</div>
<div class="weui-grids">
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 100%;">
        <p style="text-align: left;font-size: 12px;color: #a4a1a1;padding: 5px; text-indent: 24px;">
            江北新区城市候机楼提供值机办理、航班查询、贵宾休息、机场班车等 “一站式”便捷服务，进一步提升了江北新区出行环境，让出行更加舒适、便捷。
        </p>
    </a>
</div>
<style>
