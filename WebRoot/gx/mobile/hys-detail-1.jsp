...
<header>
    <figure id="full_feature" class="swipslider">
        <ul class="sw-slides">
            <li class="sw-slide">
                <img src="<%=basePath %>gx/mobile/hys-img/qyjjlb-1.jpg" width="100%" alt="">
            </li>
            <li class="sw-slide">
                <img src="<%=basePath %>gx/mobile/hys-img/qyjjlb-2.jpg" width="100%" alt="">
            </li>
            <li class="sw-slide">
                <img src="<%=basePath %>gx/mobile/hys-img/qyjjlb-3.jpg" width="100%" alt="">
            </li>
        </ul>
    </figure>
</header>
...
<div class="weui-grids">
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 55%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;">
            <img src="<%=basePath %>gx/mobile/images/img_jzmj.png" width="20px" alt="" align="absmiddle" style="margin-right: 5px;">建筑面积：<span style="color: #a4a1a1;">243m²</span>
        </p>
    </a>
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 45%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;">
            <img src="<%=basePath %>gx/mobile/images/img_cc.png" width="20px" alt="" align="absmiddle" style="margin-right: 5px;">长度*宽度：<span style="color: #a4a1a1;">27m*9m</span>
        </p>
    </a>
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 55%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;">
            <img src="<%=basePath %>gx/mobile/images/img_pm.png" width="20px" alt="" align="absmiddle" style="margin-right: 5px;">屏幕尺寸：<span style="color: #a4a1a1;">6140mm*1730mm</span>
        </p>
    </a>
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 45%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;">
            <img src="<%=basePath %>gx/mobile/images/img_fbl.png" width="20px" alt="" align="absmiddle" style="margin-right: 5px;">分辨率：<span style="color: #a4a1a1;">1920*540</span>
        </p>
    </a>
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 100%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;">
            <img src="<%=basePath %>gx/mobile/images/img_cdf.png" width="20px" alt="" align="absmiddle" style="margin-right: 5px;">场地费&nbsp;&nbsp;全天：<span style="color: #a4a1a1;">3000元</span>&nbsp;&nbsp;半天：<span style="color: #a4a1a1;">1800元</span>
        </p>
    </a>
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 100%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;">
            <img src="<%=basePath %>gx/mobile/images/img_zk.png" width="20px" alt="" align="absmiddle" style="margin-right: 5px;">园区六折：&nbsp;&nbsp;全天：<span style="color: #a4a1a1;">1800元</span>&nbsp;&nbsp;半天：<span style="color: #a4a1a1;">1000元</span>
        </p>
    </a>
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 100%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;">
            <img src="<%=basePath %>gx/mobile/images/img_rnrs.png" width="20px" alt="" align="absmiddle" style="margin-right: 5px;">容纳人数&nbsp; &nbsp;课桌式：<span style="color: #a4a1a1;">60-110人</span>&nbsp; &nbsp;剧院式：<span style="color: #a4a1a1;">110-130人</span>&nbsp; &nbsp;U型：<span style="color: #a4a1a1;">32-48人</span>
        </p>
    </a>
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 100%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;">
            <img src="<%=basePath %>gx/mobile/images/img_wz.png" width="20px" alt="" align="absmiddle" style="margin-right: 5px;">位置：<span style="color: #a4a1a1;">江北新区团结路99号研创园孵鹰大厦A座316会议室</span>
        </p>
    </a>
</div>
<div style="height: 30px;">
...
<div class="weui-grids">
    ...
    <a class="weui-grid js_grid" style="padding:5px 5px;width: 100%;">
        <p class="weui-grid__label" style="text-align: left;font-size: 12px;color: red;">
            预定此会议室赠送矿泉水1箱
        </p>
    </a>
</div>
