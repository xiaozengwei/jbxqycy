...
<form id="pagerForm" data-toggle="ajaxsearch" action="<%=basePath %>hys/hys-task-list.do" method="post">
...
<div class="bjui-pageContent tableContent">
	<table class="table table-bordered table-hover table-striped table-top" data-selected-multi="true">
		...
		<tbody>
			<c:forEach var="vMeetInstAct" items="${list }" varStatus="status">
				<tr data-id="${vMeetInstAct.rowId }">
					<td align="center"><input type="checkbox" name="ids" data-toggle="icheck" value="${vMeetInstAct.rowId}"></td>
					<td align="center">${status.count}</td>
					<td align="center">${vMeetInstAct.applicantName}</td>
					<td align="center">${vMeetInstAct.applicantPhone}</td>
					<td align="center">${vMeetInstAct.companyName}</td>
					<td align="center"><fmt:formatDate value="${vMeetInstAct.startTime }" pattern="yyyy-MM-dd HH:mm" /></td>
					<td align="center"><fmt:formatDate value="${vMeetInstAct.endTime }" pattern="yyyy-MM-dd HH:mm" /></td>
					<td align="center">${vMeetInstAct.selectedRoom }</td>
					<td align="center"><fmt:formatDate value="${vMeetInstAct.createTime }" pattern="yyyy-MM-dd" /></td>
					<td align="center">
						<a class="btn btn-green" title="查看详情" href="<%=basePath%>hys/hys-handle-page.do?rowId=${vMeetInstAct.rowId}"  data-toggle="navtab" data-id="${vMeetInstAct.rowId}">查看详情</a>
					</td>
				</tr>
			</c:forEach>
		</tbody>
