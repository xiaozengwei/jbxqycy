...
<div class="bjui-pageContent">
	<form action="<%=basePath %>/hys/hys-save.do" method="post" id="formId" data-toggle="validate">
				...
				<TR>
					...
					<td><table width="600" align="center"  cellpadding="0" cellspacing="0" class="swborder">
						...
						<tr>
							...
							<td   class="Bborder Rborder Lborder" align="left" valign="middle"><input name="companyName" type="text" style="width: 100%;" data-rule="required"></td>
						</tr>
						<tr>
							<td height="60"  valign="middle" class="Bborder Rborder Lborder" align="center"><label class="control-label x100">会议开始时间</label></td>
							<td  class="Bborder Rborder Lborder" align="left"><input name="startTime" type="text" data-toggle="datepicker" data-pattern="yyyy-MM-dd HH:mm" style="width: 100%;"  data-rule="required" readonly></td>
							<td height="60"  valign="middle" class="Bborder Rborder Lborder" align="center"><label class="control-label x100">会议结束时间</label></td>
							<td  class="Bborder Rborder Lborder" align="left"><input name="endTime" type="text" data-toggle="datepicker" data-pattern="yyyy-MM-dd HH:mm" style="width: 100%;" data-rule="required" readonly></td>
						</tr>
						<tr>
							...
							<td  class="Bborder Rborder Lborder" align="left" colspan="3">
								<select name="selectedRoom" data-toggle="selectpicker">
									<option value="企业家俱乐部">企业家俱乐部</option>
									<option value="宣讲厅">宣讲厅</option>
									<option value="大报告厅">大报告厅</option>
									<option value="会议室1">会议室1</option>
									<option value="会议室2">会议室2</option>
									<option value="会议室3">会议室3</option>
									<option value="会议室4">会议室4</option>
						...
						<tr>
							...
							<td colspan="3"  class="Bborder Rborder Lborder"><textarea rows="8" style="width: 100%;"></textarea></td>
						</tr>
						</tr>
						</tbody>
					</table></td>
