...
<div class="bjui-pageContent">
    <div style="float:left;">
        ...
        <div
            ...
            <ul id="water-floor-room-tree" class="ztree" data-toggle="ztree" data-options="{nodes:'returnTreeJSON',
                        expandAll: false ,onClick:'showUsers'}">
    ...
    <div style="margin-left:255px; height:100%;border:1px #c3ced5 solid;"  id="water-floor-room-list"></div>
...
<script type="text/javascript">
    ...
    function showUsers(event, treeId, treeNode){
        ...
        $.CurrentNavtab.bjuiajax('doLoad', {url:'<%=basePath%>water/water-device-list.do', target:'#water-floor-room-list',data:'rowId='+treeNode.id});
        event.preventDefault();
    }
    function returnTreeJSON() {
        var jsont ;
        $.ajax({
            url:'<%=basePath%>water/floor-room-tree.do',
            type:'get',
            async:false,
            cache:false,
            dataType:'json',
