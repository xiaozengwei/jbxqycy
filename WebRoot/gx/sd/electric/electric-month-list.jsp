...
<div class="bjui-pageContent tableContent">
    <table class="table table-bordered table-hover table-striped table-top" data-selected-multi="true">
        ...
        <tr>
            ...
            <th width="8%" align="center">电表id</th>
            <th width="8%" align="center">上次抄表</th>
            <th width="8%" align="center">本次抄表</th>
            <%--<th width="10%" align="center">尖</th>--%>
            <%--<th width="10%" align="center">峰</th>--%>
            <%--<th width="10%" align="center">谷</th>--%>
            <%--<th width="10%" align="center">平</th>--%>
            <th width="8%" align="center">当月已用总电量</th>
            <th width="8%" align="center">账单费用</th>
            <th width="8%" align="center">余额</th>
            <th width="8%" align="center">时间</th>
        </tr>
        </thead>
        <tbody>
        <c:forEach var="electric" items="${page.result}" varStatus="status">
            <tr>
                ...
                <%--<td align="center">${electric.flatEnergy}</td>--%>
                <td align="center"><fmt:formatNumber type="float" value="${electric.monthEnergy}" pattern="#.00"/></td>
                <td align="center"><fmt:formatNumber type="float" value="${electric.monthEnergy*0.7364}" pattern="#.00"/></td>
