...
<div class="bjui-pageContent">
    <div style="float:left;">
        ...
        <div
            ...
            <ul id="floor-room-tree" class="ztree" data-toggle="ztree" data-options="{nodes:'returnTreeJSON',
    ...
    <div style="margin-left:255px; height:100%;border:1px #c3ced5 solid;"  id="floor-room-list"></div>
    ...
    function showUsers(event, treeId, treeNode){
	 if (treeNode.isParent) {
       ...
       return;
        ...
        $.CurrentNavtab.bjuiajax('doLoad', {url:'<%=basePath%>electric/electric-device-list.do', target:'#floor-room-list',data:'rowId='+treeNode.id});
        event.preventDefault();
    }
    function returnTreeJSON() {
        var jsont ;
        $.ajax({
            url:'<%=basePath%>electric/floor-room-tree.do',
            type:'get',
            async:false,
            cache:false,
            dataType:'json',
