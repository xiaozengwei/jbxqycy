		...
		<div style="" id="wenhao-used">
			<fieldset>
				...
				<table width="100%">
					...
					<tr>
						<td style="line-height:30px; text-align:center"><label for="sysNum" class="control-label" style="line-height:30px; text-align:center">系统自动获取的号</label><input name="sysNum" id="sysNum" /></td>
